...
# Pemodelan SVM dengan kernel polynomial
model = SVC(kernel='poly', degree=3)  # Menggunakan kernel polynomial dengan degree 3
...
plt.title('Confusion Matrix SVM dengan Kernel Polynomial')
...
print("AKURASI SVM DENGAN KERNEL POLYNOMIAL".center(100, "="))
...
plt.pie(
    ...
    autopct='%1.1f%%',
    startangle=140,
    colors=['#C70909', '#826AE0']
)
plt.title('Akurasi SVM dalam Memprediksi Spam vs Ham dengan Kernel Polynomial')
plt.show()
